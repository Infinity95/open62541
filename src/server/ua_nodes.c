...
UA_Node_deleteMembers(UA_Node *node) {
    ...
    case UA_NODECLASS_OBJECT:break;
    case UA_NODECLASS_METHOD:break;
    case UA_NODECLASS_OBJECTTYPE:break;
    ...
    case UA_NODECLASS_DATATYPE:break;
    case UA_NODECLASS_VIEW:break;
    default:break;
    }
}
...
UA_Node_copy(const UA_Node *src, UA_Node *dst) {
    ...
    case UA_NODECLASS_OBJECT:retval = UA_ObjectNode_copy((const UA_ObjectNode *)src, (UA_ObjectNode *)dst);
        break;
    case UA_NODECLASS_VARIABLE:retval = UA_VariableNode_copy((const UA_VariableNode *)src, (UA_VariableNode *)dst);
        break;
    case UA_NODECLASS_METHOD:retval = UA_MethodNode_copy((const UA_MethodNode *)src, (UA_MethodNode *)dst);
        break;
    ...
    case UA_NODECLASS_REFERENCETYPE:
        ...
        break;
    case UA_NODECLASS_DATATYPE:retval = UA_DataTypeNode_copy((const UA_DataTypeNode *)src, (UA_DataTypeNode *)dst);
        break;
    case UA_NODECLASS_VIEW:retval = UA_ViewNode_copy((const UA_ViewNode *)src, (UA_ViewNode *)dst);
        break;
    default:break;
    }
...
UA_Node_copy_alloc(const UA_Node *src) {
    ...
    void *dstPtr;
    switch(src->nodeClass) {
    case UA_NODECLASS_OBJECT:dstPtr = UA_malloc(sizeof(UA_ObjectNode));
        break;
    case UA_NODECLASS_VARIABLE:dstPtr = UA_malloc(sizeof(UA_VariableNode));
        break;
    case UA_NODECLASS_METHOD:dstPtr = UA_malloc(sizeof(UA_MethodNode));
        break;
    case UA_NODECLASS_OBJECTTYPE:dstPtr = UA_malloc(sizeof(UA_ObjectTypeNode));
        break;
    case UA_NODECLASS_VARIABLETYPE:dstPtr = UA_malloc(sizeof(UA_VariableTypeNode));
        break;
    case UA_NODECLASS_REFERENCETYPE:dstPtr = UA_malloc(sizeof(UA_ReferenceTypeNode));
        break;
    case UA_NODECLASS_DATATYPE:dstPtr = UA_malloc(sizeof(UA_DataTypeNode));
        break;
    case UA_NODECLASS_VIEW:dstPtr = UA_malloc(sizeof(UA_ViewNode));
        break;
    default:return NULL;
    }
